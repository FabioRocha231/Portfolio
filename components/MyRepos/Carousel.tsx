      ...
      state?.map(
        (git, i) =>
          ...
          i >= 0 + bounds.limit * page && (
            ...
            >
              <div className="relative flex h-[250px] w-[250px] flex-col items-center justify-evenly gap-y-5 rounded-3xl bg-repos bg-cover bg-center bg-no-repeat p-2 text-center">
                <span className="absolute  h-full w-full  rounded-3xl bg-[#4E7AC7]/10 backdrop-blur-sm" />

                <article className="-mt-20 flex flex-row items-center justify-center gap-x-3">
                  <Image
